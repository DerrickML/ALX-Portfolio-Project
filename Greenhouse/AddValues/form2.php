                                ...
                                <form action="?" method="post">
                                    <div class="inputs">
                                        ...
                                        <div class="in">
                                            ...
                                            <span><input id="moisture" name="moisture"
                                                    placeholder="Input Value..." /></span>
                                        </div>

                                        <div class="in">
                                            <label for="joketext">Min:</label>
                                            <span><input id="moisture2" name="moisture2"
                                                    placeholder="Input Value..." /></span>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="inputs">
                                        ...
                                        <div class="in">
                                            <label for="joketext">Max:</label>
                                            <span><input id="light" name="light2" placeholder="Input Value..." /></span>
                                        </div>
                                        <div class="in">
                                            <label for="joketext">Min:</label>
                                            <span><input id="light2" name="light2"
                                                    placeholder="Input Value..." /></span>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="inputs">
                                        ...
                                        <div class="in">
                                            <label for="joketext">Max:</label>
                                            <span><input id="temp" name="temp2" placeholder="Input Value..." /></span>
                                        </div>
                                        <div class="in">
                                            <label for="joketext">Min:</label>
                                            <span><input id="temp2" name="temp2" placeholder="Input Value..." /></span>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="inputs">
                                        ...
                                        <div class="in">
                                            <label for="joketext">Max</label>
                                            <span><input id="humidity" name="humidity"
                                                    placeholder="Input Value..." /></span>
                                        </div>
                                        <div class="in">
                                            <label for="joketext">Min</label>
                                            <span><input id="humidity2" name="humidity2"
                                                    placeholder="Input Value..." /></span>
                                        </div>
                                    </div>
                                    <hr>

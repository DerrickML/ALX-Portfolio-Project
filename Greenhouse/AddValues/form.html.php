...
<head>
    ...
    <link href="http://localhost/Greenhouse/fontawesome-free-5.13.0-web/fontawesome-free-5.13.0-web/css/fontawesome.css"
        rel="stylesheet">
    <link href="http://localhost/Greenhouse/fontawesome-free-5.13.0-web/fontawesome-free-5.13.0-web/css/brands.css"
        rel="stylesheet">
    <link href="http://localhost/Greenhouse/fontawesome-free-5.13.0-web/fontawesome-free-5.13.0-web/css/all.css"
        rel="stylesheet">
    <link href="http://localhost/Greenhouse/fontawesome-free-5.13.0-web/fontawesome-free-5.13.0-web/css/solid.css"
        rel="stylesheet">
